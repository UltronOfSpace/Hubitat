...
1. First, head over to [this GitHub page right here](https://github.com/UltronumusOfSpace/Hubitat/blob/main/Libraries%20Code/AppControlLib/AppControlLib.groovy)—don’t lose it like I lose my dope!
...
7. Paste the URL you copied (it’ll look like `https://raw.githubusercontent.com/UltronumusOfSpace/Hubitat/main/Libraries%20Code/AppControlLib/AppControlLib.groovy`).
8. Click **Import**, then **Save**. Done, you greasy fella!

### Option 2: Copy and Paste from GitHub

1. Head over to [this link right here](https://github.com/UltronumusOfSpace/Hubitat/blob/main/Libraries%20Code/AppControlLib/AppControlLib.groovy)—don’t lose it like I lose my dope!
...
- [**AppControlLibParentAppTemplate**: The big boss app](./AppControlLibParentAppTemplate_README.md) that makes a bunch of little punk kid apps and tells ‘em what to do.
- [**AppControlLibChildAppTemplate**: The little punk kid app](./AppControlLibChildAppTemplate_README.md) that does what the big boss app says, with its own pause button.
- [**AppControlLibStandaloneAppTemplate**: The lone wolf app](./AppControlLibStandaloneAppTemplate_README.md) that don’t need nobody, just its own pause button.
