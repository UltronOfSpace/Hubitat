...
- [**AppControlLib Parent And Child Example**: The big boss app and its little punk kid apps](../ExampleApps/ParentAndChild/AppControlLibParentAndChildExample_README.md)—shows you how to make a big boss app that makes a bunch of little punk kid apps and tells ‘em what to do, plus how the little punk kid app listens to the big boss.
- [**AppControlLib Standalone Example**: The lone wolf app](../ExampleApps/Standalone/AppControlLibStandaloneExample_README.md)—don’t need nobody, just its own pause button.
